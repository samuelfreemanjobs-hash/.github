# project.md session prompts

Two variants (plus status). Paste one at the **start of any session**.
...
- The `project.md` lives in the **project root**. Commit it alongside your code.
